...
#define BOARD_CFG_GPIO_ADC_VIN ADC_CHANNEL_2 // gpio 3

#define BOARD_CFG_ADC_RH 33000
#define BOARD_CFG_ADC_RL  3300

#define BOARD_CFG_ADC_RATIO_MV ((BOARD_CFG_ADC_RH + BOARD_CFG_ADC_RL) / BOARD_CFG_ADC_RL)
